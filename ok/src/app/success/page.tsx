                ...
                <div>
                    ...
                    >
                        ...
                        <a
                            ...
                            className="inline-flex items-center px-6 py-3 bg-[#1877F2] hover:bg-[#166FE5] text-white font-medium rounded-lg transition-colors duration-200 gap-2 justify-center"
                        >
                            <svg
                                className="w-6 h-6"
                                fill="currentColor"
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center px-6 py-3 text-white font-medium rounded-lg transition-all duration-200 gap-2 justify-center bg-gradient-to-tr from-[#FF7A00] via-[#E0015F] to-[#7A0BF6] hover:opacity-90"
                        >
                            <svg
                                className="w-6 h-6"
                                fill="currentColor"
